...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
  <head>
    ...
    <meta name="Description" content="Compare competitor lists" />
  ...
  <body>
    <div class="container text-center">
      <form class="row justify-content-center" action="src/compare-lists.php" method="POST">
      ...
      <footer class="my-4 py-3">
        <ul class="nav justify-content-center mb-3 pb-3">
          <li class="nav-item">
            <a href="#" class="nav-link px-2 text-muted">© COMPare 2024-<?php echo date( 'Y' ); ?></a>
          </li>
          <li class="nav-item">
