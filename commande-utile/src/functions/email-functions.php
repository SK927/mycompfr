<?php
  ...
  function send_order_confirmation( $competition_data, $order_id, $user_email, $user_name, $user_order, $user_comment = null, $order_total, $is_edit = null )
  {        
    ...
    {
      $message .= "<p><b>{$catalog[ $block_key ]['name']}</b>&nbsp;: ";

      foreach ( $block['items'] as $item_key => $item )
      {
        $message .= "{$item['qty']} x {$catalog[ $block_key ]['items'][ $item_key ]['name']}";
    ...
    $message .= " <a href=\"https://{$_SERVER['SERVER_NAME']}/{$folder}/";
    $message .= '" target=\'_blank\'">cliquez ici</a>.</p>';
    $message .= '<p>Bonne journ&eacute;e et &agrave; bient&ocirc;t.</p>';
    $message .= '<p>----</p>';
    $message .= "<p>L'&eacute;quipe organisatrice de {$competition_data['competition_name']}</p>";
    $message .= '</body></html>';
  ...
  function send_deletion_competition( $competition_id, $orga_email, $all_administrators_email )
  {
    ...
    $message .= " supprim&eacute;e du site <a href=\"https://{$_SERVER['SERVER_NAME']}/{$folder}/\">Commande Utile</a>.</p>";
    $message .= '<p>Bonne journ&eacute;e et &agrave; bient&ocirc;t.</p>';
    $message .= '<p>----</p>';
  ...
  function send_deletion_credentials( $administrator_login, $administrator_email, $other_administrators_email )
  {
    ...
    $message .= " supprim&eacute;s du site <a href=\"https://{$_SERVER['SERVER_NAME']}/{$folder}/\">Commande Utile</a>.</p>";
    $message .= '<p>Bonne journ&eacute;e et &agrave; bient&ocirc;t.</p>';
    $message .= '<p>----</p>';
    $message .= '<p>L\'&eacute;quipe d\'administration de Commande Utile</p>';
    $message .= '</body></html>';
  ...
  function send_creation_competition( $competition_id, $orga_email, $all_administrators_email )
  {
    ...
    $message .= '<p>Bonjour,</p>';
    $message .= "<p>La comp&eacute;tition ID <b>{$competition_id}</b> a bien &eacute;t&eacute;";
    $message .= " cr&eacute;&eacute;e sur le site <a href=\"https://{$_SERVER['SERVER_NAME']}/{$folder}/\">Commande Utile</a>.</p>";
