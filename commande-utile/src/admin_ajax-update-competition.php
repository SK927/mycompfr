<?php
  ...
  {    
    ...
    {
      $sql = "UPDATE {$db['cu']}_Main SET contact_email = '{$competition_contact_email}', orders_closing_date = '{$competition_orders_closing_date}', competition_information = '{$competition_info}' WHERE competition_id = '{$competition_id}'";
