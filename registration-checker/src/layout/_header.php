  ...
  <body>
    <?php if ( ! isset( $_SESSION['user_email'] ) and $_SESSION['logged_in'] ): ?>
      <div class="container-fluid py-3 bg-warning border-bottom text-dark">
        <b>WARNING:</b> Your email address was not retrieved when you signed in to MyComp (probable cause: you first signed in to a tool that is not using the email address). Please sign in again to avoid any malfunction when saving your response.
      </div>
    <?php endif ?>
