<?php
  ...
  {      
    ...
    $query_results = $conn->query( "SELECT administrator_email FROM " . DB_PREFIX . "_AdminCredentials WHERE administrator_login = '{$id}';"); /* Get selected competition contact email */  
