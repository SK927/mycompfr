...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
  <head>
    ...
    <meta name="Description" content="Site de centralisation des newsletters AFS" />
      ...
      <div class="container-fluid">
        ...
        <span class="navbar-text text-white">
          <?php if ( $_SESSION['logged_in'] ): ?>
            ...
            <?php if ( in_array( $_SESSION['user_wca_id'], ADMINS_ID ) ): ?>
              <a class="log-in-and-out" href="https://<?php echo $_SERVER['SERVER_NAME'] ?>/afs/admin-edit-newsletter">(Administrer)</a>
            <?php endif ?>
            <a class="log-in-and-out" href="https://<?php echo $_SERVER['SERVER_NAME'] ?>/src/sessions/session-quit">(Se déconnecter)</a>
          <?php else: ?>
            <a class="log-in-and-out" href="https://<?php echo "{$_SERVER['SERVER_NAME']}/portal?captive_for={$site_alias}/admin-edit-newsletter&locale=FR" ?>">Se connecter avec la WCA</a>
          <?php endif; ?>
        </span>
      </div>
    </nav>
