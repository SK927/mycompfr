<?php 
  ...
  $site_name = 'Registration Handler';
  $site_alias = 'registration-handler';
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
  ...
  <body>
    <?php if ( (! isset( $_SESSION['user_email'] ) or ! isset( $_SESSION['user_dob'] )) and $_SESSION['logged_in'] ): ?>
      <div class="container-fluid py-3 bg-warning border-bottom text-dark">
        <b>WARNING:</b> Your email address or date of birth was not retrieved when you signed in to MyComp (probable cause: you first signed in to a tool that is not using these information). Please sign in again to avoid any malfunction when saving your registration.
      </div>
    <?php endif ?>
      ...
      <div class="container-fluid">
        ...
        <span class="navbar-text text-dark">
          <?php if ( $_SESSION['logged_in'] ): ?>
            <?php echo $_SESSION['user_name']; ?> <a class="log-in-and-out" href="https://<?php echo $_SERVER['SERVER_NAME'] ?>/src/sessions/session-quit">(Log out)</a>
          <?php else: ?>
