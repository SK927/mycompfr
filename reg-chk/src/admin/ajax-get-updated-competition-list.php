<?php
  ...
  if ( $_SESSION['logged_in'] AND $_POST['valid'] )
  {
    ...
    $query_results = $conn->query( "SELECT * FROM " . DB_PREFIX . "_Main WHERE competition_registrations LIKE '%\"{$user_id}\"%' ORDER BY competition_start_date ASC, competition_name ASC;" );
