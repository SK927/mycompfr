...
$( document ).on( 'keyup', '.item-price, .item-options-select-price', function()
{
  ...
  this.value = String( (number/ 100).toFixed( 2 ) ); // Format new numeric value
}); 
...
function updateList( )
{
  ...
  $.ajax( {
    type: 'POST',
    url: 'src/admin/ajax-get-catalog.php',
