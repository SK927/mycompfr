...
?>
          ...
          <div class="card">
            ...
            <div class="card-body"> 
              <?php foreach ( $user_upcoming_manageable_competitions as $competition ): ?>  
                <div id="<?php echo $competition['id']; ?>_admin" class="row my-2 py-2 px-4">
                  ...
                  <?php if ( $competition['is_imported'] ): ?>
                    <script>displayImported( '<?php echo addslashes( $competition['id'] ); ?>' );</script>
                  <?php else:?>
      ...
      <?php endif; ?>  
      <?php require_once "../src/layout/_status-bar.php"; ?>
