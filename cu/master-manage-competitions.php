              ...
              <div class="card-body col-12 text-start">
                <div class="row text-start">
                  ...
                  <div class="col-12 text-end mb-4">
                    <button id="add-competition" class="btn btn-light my-1" data-bs-toggle="collapse" data-bs-target="#form-competition" aria-expanded="false">Ajouter une compétition</button>
                  </div>  
                </div>
            ...
            <div class="card section">
              ...
              <div class="card-body col-12 text-start">
                <div class="row text-start">
                  ...
                  <form id="form-administrator" class="collapse col-12" action="src/master/ajax-create-new-administrator" method="POST" aria-expanded="false">
