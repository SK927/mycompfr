      <template id="block">
        <div id="" class="block col-12 card mt-2 p-0">
          <div class="card-header">
            <div class="row">
              <div class="col-lg-5">
                <input id="" type="text" class="form-control block-name mb-1 mb-xl-0 me-1" placeholder="Nom du bloc" name="" value="">
              </div>
              <div class="col-auto">
        ...
        <div id="" class="item col-lg-6 py-3 mb-2">
          <div class="row px-3 pb-3">
            <div class="col-md-2 m-0 text-end align-self-center">
              <button class="delete-item btn btn-sm btn-outline-danger" name="">
            </div>
            ...
            <div class="add-option col-md-4 offset-md-2 my-0 p-1 text-start">
              + Option
            </div>
          </div>
        </div>
      ...
      <template id="option">
        <div class="col-12 option">
          <div class="row">
            <div class="col-md-2 offset-md-1 text-end align-self-center">
              <button class="delete-option btn btn-sm btn-outline-danger" name="">
            </div>
            <div class="col-md-3 my-0 p-1 text-left">
              <input type="text" class="form-control item-option-name" name="" placeholder="Nom option" value="" />
            </div>
            <div class="col-md-6 my-0 p-1 text-left">
              <input type="text" class="form-control item-option-value" name="" placeholder="Choix" value="" />
            </div>
          </div>
        </div>
      </template>
