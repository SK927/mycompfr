<?php
  ...
  {    
    ...
    if( $login != "Administrator" )
    {
      ...
      $results = $conn->query( "SELECT administrator_email FROM ". DB_PREFIX_CU . "_AdminCredentials WHERE administrator_login = '{$login}';" ); /* Get selected competition contact email */  
