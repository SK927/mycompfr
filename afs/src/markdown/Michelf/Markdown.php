...
class Markdown implements MarkdownInterface {
	...
	protected function _doAnchors_reference_callback($matches) {
		...
		if (isset($this->urls[$link_id])) {
			...
			$result = "<a href=\"$url\" style=\"color: #e67e23\" target=\"_blank\"";
	...
	protected function _doImages_reference_callback($matches) {
		...
		if (isset($this->urls[$link_id])) {
			...
			$result = "<img src=\"$url\" alt=\"$alt_text\" align=\"center\" border=\"0\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;margin-top:5px;margin-bottom:5px;\"/";
			if (isset($this->titles[$link_id])) {
				$title = $this->titles[$link_id];
				$title = $this->encodeAttribute($title);
				$result .=  " title=\"$title\"";
...
//				}
	...
	protected function _doAutoLinks_url_callback($matches) {
		...
		$link = "<a href=\"$url\" style=\"color: #e67e23\" target=\"_blank\">$text</a>";
