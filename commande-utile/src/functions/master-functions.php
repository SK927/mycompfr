<?php
  ...
  {   
    $query_results = $mysqli->query( "SELECT * FROM " . DB_PREFIX_CU . "_Main ORDER BY competition_start_date, competition_name ASC;" );
  ...
  {   
    $administrators_list = [];
    $query_results = $mysqli->query( "SELECT administrator_login, administrator_email FROM ". DB_PREFIX_CU . "_AdminCredentials ORDER BY administrator_login ASC;" );
  ...
  function get_administrators_emails( $mysqli, $banned_login = '' )
  {
    ...
    $query_results = $mysqli->query( "SELECT administrator_email FROM ". DB_PREFIX_CU . "_AdminCredentials WHERE administrator_login != '{$banned_login}';" );
  ...
  {      
    $sql = "CREATE TABLE ". DB_PREFIX_CU . "_{$competition_id} (
  ...
  {    
    $sql = "ALTER TABLE " . DB_PREFIX_CU . "_{$competition_id} ADD PRIMARY KEY (id), ADD UNIQUE KEY(id);";
  ...
  {
    $sql = "DROP TABLE " . DB_PREFIX_CU . "_{$competition_id};";  
  ...
  {
    $sql = "DELETE FROM " . DB_PREFIX_CU . "_Main WHERE competition_id = '{$competition_id}';"; 
  ...
  function create_administrator_in_db( $id, $email, $mysqli )
  {
    ...
    $sql = "REPLACE INTO " . DB_PREFIX_CU . "_AdminCredentials ( administrator_login, administrator_password, administrator_email ) VALUE ( '{$id}', '{$encrypted_password}', '{$encrypted_email}');";
  ...
  function regenerate_administrator_password( $id, $email, $mysqli )
  {
    ...
    $sql = "UPDATE " . DB_PREFIX_CU . "_AdminCredentials SET administrator_password = '{$encrypted_password}' WHERE administrator_login = '{$id}';";
  ...
  {
    $sql = "DELETE FROM " . DB_PREFIX_CU . "_AdminCredentials WHERE administrator_login = '{$id}';"; 
