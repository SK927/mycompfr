<?php
  ...
  require_once dirname( __FILE__ ) . '/generic-functions.php';
   ...
   * @return (array) the data retrieve via WCA API and the error generated if needed
   */
  ...
  { 
    ...
    $function_return = $error ? array( null, $error ) : array( $response['persons'], $error );
