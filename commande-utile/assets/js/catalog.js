...
function createSelection( optionId, name = '', price = '0.00' )
{
  ...
  clone.querySelector( '.item-options-select-price' ).value = parseFloat( price ).toFixed( 2 ); 
...
function updateBlocks( blockList )
{
  blockList.querySelectorAll( '.block').forEach( function( elem, i )
  {
    ...
    elem.querySelector( '.delete-block' ).name = elem.id + '-f(delete-block)'; 
    elem.querySelector( '.clone-block' ).name = elem.id + '-f(clone-block)'; 
...
function updateBlockTop()
{
  var position = document.getElementById( 'catalog-tools' ).getBoundingClientRect();
  document.getElementById( 'form-manual' ).querySelectorAll( '.sticky-top' ).forEach((elem) => {
...
$( document ).ready( function() {
  var position = document.getElementById( 'catalog-tools' ).getBoundingClientRect();
  document.getElementById( 'catalog-tools' ).style.top = position.top + 'px';
