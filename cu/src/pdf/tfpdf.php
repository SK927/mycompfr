...
class CustomPDF extends tFPDF
{
  ...
  function Header()
  {
    ...
    $this->Image("https://$server_url/assets/img/favicon.png",10,6,15,'PNG');
    // Arial bold 15
  ...
  function RowMenu($data, $fill, $p)
  {
    ...
    for($i=0;$i<count($data);$i++)
    {
      ...
      {
        // Print the text
        $this->MultiCell($w,$p,$data[$i],0,$a, $fill);
      }
