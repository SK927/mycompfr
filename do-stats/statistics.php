...
<div class="container-fluid">
  ...
  <?php if ( isset( $_GET['view_as'] ) ): ?>
    <div class="alert alert-warning" role="alert">
      You are viewing statistics as competitor <b><?php echo $_GET['view_as'] ?></b>. These statistics may not be up to date if the competitor has not logged in to DO Stats for a while!
    </div>
  <?php endif ?>
