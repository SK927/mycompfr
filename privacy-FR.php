...
<div class="container">
  ...
  <div class="row">
    <div class="col-12 mt-3">
      <div class="card">
        <div class="card-header text-center">ARTICLE 1 : PRÉAMBULE</div>
        <div class="card-body p-5">
          <p>La présente politique de confidentialité a pour but d’informer les utilisateurs du site :</p>
          <ul>
            <li>Sur la manière dont sont collectées leurs données personnelles. Sont considérées comme des données personnelles, toute information permettant d’identifier un utilisateur. A ce titre, il peut s’agir : de ses noms et prénoms, de sa date de naissance, ou encore de son adresse e-mail (liste non-exhaustive) ;</li>
    ...
    <div class="col-12 mt-3">
      <div class="card">
        <div class="card-header text-center">ARTICLE 2 : PRINCIPES RELATIFS À LA COLLECTE ET AU TRAITEMENT DES DONNÉES PERSONNELLES</div>
        <div class="card-body p-5">
          ...
          <ul>
            ...
            <li>Collectées pour des finalités déterminées (cf. Article 3.1 des présentes), explicites et légitimes, et ne sont pas être traitées ultérieurement d'une manière incompatible avec ces finalités ;</li>
    ...
    <div class="col-12 mt-3">
      <div class="card">
        <div class="card-header text-center">ARTICLE 3 : DONNÉES À CARACTÈRE PERSONNEL COLLECTÉES ET TRAITÉES DANS LE CADRE DE LA NAVIGATION SUR LE SITE</div>
        <div class="card-body p-5">
          ...
          <ul>
            <li>ID utilisateur WCA ;</li> 
            <li>Nom et prénom ;</li> 
            <li>Date de naissance ;</li> 
            <li>Adresse e-mail ;</li> 
            <li>ID WCA ;</li> 
            <li>Genre ;</li> 
            <li>Pays de représentation ;</li> 
            <li>Jeton de connexion à l'API WCA ;</li> 
            <li>Compétitions gérées sur le site WCA.</li> 
          </ul>
          ...
          <ul>
            ...
            <li>Affichage des historiques de compétitions.</li>         
          </ul>

          <h5 class="mt-5">Article 3.2 : Mode de collecte des données</h5>
          ...
          <p>Le site MyComp est hébergé par :</p>
          <ul>
            OVH<br/>  
          ...
          <h5 class="mt-5">Article 3.4 : Transmission des données à des tiers</h5>
          <p>Aucune données n'est transmise ou vendue à un tiers.</p>

          <h5 class="mt-5">Article 3.5 : Politique en matière de cookies</h5>
          <p>Les cookies utilisés sur le site ne permettent que l'identification de la sessions en cours. Aucune données personnelle n'est stockée dans les cookies du site.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 mt-3">
      <div class="card">
        <div class="card-header text-center">ARTICLE 4 : RESPONSABLE DU TRAITEMENT DES DONNÉES ET DÉLÉGUÉ À LA PROTECTION DES DONNÉES</div>
        <div class="card-body p-5">
          <p>Le responsable du traitement des données à caractère personnel (Maxime Lefebvre) peut être contacté de la manière suivante :</p> 
          <ul> 
            <li>Par e-mail : <a href="mailto:speedkubing927@gmail.com">speedkubing927@gmail.com</a>.</li>
          </ul>
          <p>Si vous estimez, après nous avoir contactés et que vos droits “Informatique et Libertés” ne sont pas respectés, vous pouvez adresser une information à la CNIL.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 mt-3">
      <div class="card">
        <div class="card-header text-center">ARTICLE 5 : LES DROITS DE L’UTILISATEUR EN MATIÈRE DE COLLECTE ET DE TRAITEMENT DES DONNÉES</div>
        <div class="card-body p-5">
          ...
          <p>Pour exercer vos droits, veuillez adresser votre courrier par e-mail à <a href="mailto:speedkubing927@gmail.com">speedkubing927@gmail.com</a>.</p>
          <p>Afin que le responsable du traitement des données puisse faire droit à sa demande, l’utilisateur peut être tenu de lui communiquer certaines informations telles que : ses noms et prénoms, son adresse e-mail ainsi que toute information permettant de l'identifier informatiquement. </p>
    ...
    <div class="col-12 mt-3">
      <div class="card">
        <div class="card-header text-center">ARTICLE 6 : CONDITIONS DE MODIFICATION DE LA POLITIQUE DE CONFIDENTIALITÉ</div>
        <div class="card-body p-5">
